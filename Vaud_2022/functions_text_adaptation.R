...
green_cleanup_fr <- function(text, anzahl_sitze_partei) {
  ...
  text <- gsub("le Verts détient ","les Verts détiennent ",text)
  text <- gsub("le Vert'libéraux détient ","les Vert'libéraux détiennent ",text)
  text <- gsub("le Libres détient ","les Libres détiennent ",text)
