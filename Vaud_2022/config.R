...
Listen_und_Parteien <- read_excel("Daten/LENA_Listen_Kanton_Vaud.xlsx", 
                                      sheet = "Listen_Parteien")

Sitzverteilung_Historisch <- read_excel("Daten/LENA_Listen_Kanton_Vaud.xlsx", 
                                  sheet = "Sitzverteilung_2017")
